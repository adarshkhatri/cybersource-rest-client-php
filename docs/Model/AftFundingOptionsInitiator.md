...
------------ | ------------- | ------------- | -------------
**originatorInitiatedTransaction** | [**\CyberSource\Model\AftFundingOptionsInitiatorOriginatorInitiatedTransaction**](AftFundingOptionsInitiatorOriginatorInitiatedTransaction.md) |  | [optional] 
