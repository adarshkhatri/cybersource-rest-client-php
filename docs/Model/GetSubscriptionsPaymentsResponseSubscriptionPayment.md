...
**date** | [**\DateTime**](\DateTime.md) | The date and time of the payment processing. | [optional] 
...
**billingStartDate** | [**\DateTime**](\DateTime.md) | The start date of the billing cycle for this payment. | [optional] 
**billingEndDate** | [**\DateTime**](\DateTime.md) | The end date of the billing cycle for this payment. | [optional] 
