...
**offer** | [**\CyberSource\Model\InlineResponse20016OrderInformationCurrencyConversionOffer[]**](InlineResponse20016OrderInformationCurrencyConversionOffer.md) | When type is DCC this is a single item. When type is MCP this is an array that repeats for each currency that&#39;s configured by the currency conversion provider for the merchant. | [optional] 
