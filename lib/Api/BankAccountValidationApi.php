        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse40014', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 403:
                    ...
                    break;
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4046', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    ...
                    break;
                case 502:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse5024', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
