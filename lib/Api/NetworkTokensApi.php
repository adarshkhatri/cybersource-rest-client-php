...
/**
 * NetworkTokensApi Class Doc Comment
 *
 * @category Class
 * @package  CyberSource
 * @author   Swagger Codegen team
...
class NetworkTokensApi
{
    ...
    /**
     * Operation postTokenizedCardDelete
     *
     ...
     * @return array of void, HTTP status code, HTTP response headers (array of strings)
     */
    public function postTokenizedCardDelete($tokenizedCardId, $profileId = null, $postTokenizedCardDeleteRequest = null)
    {
        self::$logger->info('CALL TO METHOD postTokenizedCardDelete STARTED');
        list($response, $statusCode, $httpHeader) = $this->postTokenizedCardDeleteWithHttpInfo($tokenizedCardId, $profileId, $postTokenizedCardDeleteRequest);
        self::$logger->info('CALL TO METHOD postTokenizedCardDelete ENDED');
        self::$logger->close();
        return [$response, $statusCode, $httpHeader];
    }

    /**
     * Operation postTokenizedCardDeleteWithHttpInfo
     *
     * Delete a Tokenized Card
     *
     * @param string $tokenizedCardId The Id of a tokenized card. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postTokenizedCardDeleteWithHttpInfo($tokenizedCardId, $profileId = null, $postTokenizedCardDeleteRequest = null)
    {
        // verify the required parameter 'tokenizedCardId' is set
        if ($tokenizedCardId === null) {
            self::$logger->error("InvalidArgumentException : Missing the required parameter $tokenizedCardId when calling postTokenizedCardDelete");
            throw new \InvalidArgumentException('Missing the required parameter $tokenizedCardId when calling postTokenizedCardDelete');
        }
        // parse inputs
        $resourcePath = "/tms/v2/tokenized-cards/{tokenizedCardId}/delete";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        // body params
        $_tempBody = null;
        if (isset($postTokenizedCardDeleteRequest)) {
            $_tempBody = $postTokenizedCardDeleteRequest;
        }
        ...
        //MLE check and mle encryption for req body
        $inboundMLEStatus = 'optional';
        if (MLEUtility::checkIsMLEForAPI($this->apiClient->merchantConfig, $inboundMLEStatus, "postTokenizedCardDelete,postTokenizedCardDeleteWithHttpInfo")) {
            try {
                $httpBody = MLEUtility::encryptRequestPayload($this->apiClient->merchantConfig, $httpBody);
            } catch (Exception $e) {
                self::$logger->error("Failed to encrypt request body:  $e");
        ...
        // Response MLE check
        $isResponseMLEForAPI = MLEUtility::checkIsResponseMLEForAPI($this->apiClient->merchantConfig, "postTokenizedCardDelete,postTokenizedCardDeleteWithHttpInfo");
