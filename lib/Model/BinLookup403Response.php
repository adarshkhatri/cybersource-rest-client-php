...
/**
 * BinLookup403Response Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BinLookup403Response implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'binLookup403Response';
    ...
    /**
     * Sets status
     * @param string $status The status of the submitted transaction.  Possible values:  - FORBIDDEN_ACCESS
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason The reason of the status.  Possible values:  - FORBIDDEN_ACCESS
     * @return $this
     */
