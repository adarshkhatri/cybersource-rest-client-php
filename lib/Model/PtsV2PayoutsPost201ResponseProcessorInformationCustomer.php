...
/**
 * PtsV2PayoutsPost201ResponseProcessorInformationCustomer Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PtsV2PayoutsPost201ResponseProcessorInformationCustomer implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ptsV2PayoutsPost201Response_processorInformation_customer';
     ...
     * @param string $personalIdResult Personal identifier validation result.  Valid values: - '1': Verified - '2': Failed - '3': Not performed - '4': Issuer does not support id verification
     * @return $this
     */
