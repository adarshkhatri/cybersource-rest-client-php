    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (Configuration::getDefaultConfiguration()->getLogConfiguration()->isLoggingEnabled()) {
                $tempLogger = (new LogFactory())->getLogger(\CyberSource\Utilities\Helpers\ClassHelper::getClassName(__CLASS__), Configuration::getDefaultConfiguration()->getLogConfiguration());
